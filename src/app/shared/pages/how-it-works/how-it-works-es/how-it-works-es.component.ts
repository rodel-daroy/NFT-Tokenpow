...
@Component({
  selector: 'app-how-it-works-es',
  templateUrl: './how-it-works-es.component.html',
  styleUrls: ['./how-it-works-es.component.scss']
})
export class HowItWorksEsComponent implements OnInit, OnDestroy {
