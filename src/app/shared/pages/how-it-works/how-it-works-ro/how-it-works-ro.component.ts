...
@Component({
  selector: 'app-how-it-works-ro',
  templateUrl: './how-it-works-ro.component.html',
  styleUrls: ['./how-it-works-ro.component.scss']
})
export class HowItWorksRoComponent implements OnInit, OnDestroy {
